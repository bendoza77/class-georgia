...
export default function PrivacyPolicy() {
  ...
  const hero = t('privacyPolicy.hero', { returnObjects: true })
  const sections = t('privacyPolicy.sections', { returnObjects: true })
  const cta = t('privacyPolicy.cta', { returnObjects: true })

  useDocumentTitle('Privacy Policy — Class Georgia')
      ...
      <section className="relative py-20 lg:py-28 overflow-hidden bg-dark-800">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-0 w-96 h-96 rounded-full opacity-[0.04]"
            style={{ background: 'radial-gradient(circle, #5B0E2D, transparent 70%)', transform: 'translate(-30%, -30%)' }} />
          ...
          <div className="max-w-3xl mx-auto space-y-16">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a
                  href="mailto:privacy@classgeorgia.com"
